...
FUNCTION ze_Cnab033( aBoletoList )
   ...
   WITH OBJECT oBoleto
      ...
      /* 018-032 */ cTxt += Padl( SoNumero( :cEmpCnpj ), 15, "0" )
      ...
      /* 019-033 */ cTxt += Padl( SoNumero( :cEmpCnpj ), 15, '0' )
